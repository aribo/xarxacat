...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Periodista.created_by'
        db.alter_column(u'premsa_periodista', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Agencia.created_by'
        db.alter_column(u'premsa_agencia', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Mitja.created_by'
        db.alter_column(u'premsa_mitja', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Periodista.created_by'
        raise RuntimeError("Cannot reverse this migration. 'Periodista.created_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Periodista.created_by'
        db.alter_column(u'premsa_periodista', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Agencia.created_by'
        raise RuntimeError("Cannot reverse this migration. 'Agencia.created_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Agencia.created_by'
        db.alter_column(u'premsa_agencia', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Mitja.created_by'
        raise RuntimeError("Cannot reverse this migration. 'Mitja.created_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Mitja.created_by'
        db.alter_column(u'premsa_mitja', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
