...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Periodista.tipus'
        db.alter_column(u'premsa_periodista', 'tipus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Periodista_Tipus'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Periodista.tipus'
        raise RuntimeError("Cannot reverse this migration. 'Periodista.tipus' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Periodista.tipus'
        db.alter_column(u'premsa_periodista', 'tipus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Periodista_Tipus']))
