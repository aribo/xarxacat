...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Periodista_Carrec'
        db.create_table(u'premsa_periodista_carrec', (
        ...
        db.send_create_signal(u'premsa', ['Periodista_Carrec'])

        # Adding model 'Periodista'
        db.create_table(u'premsa_periodista', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cognoms', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('tipus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Periodista_Tipus'])),
            ('carrec', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Periodista_Carrec'])),
            ('pais_origen', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pais_origen_set', to=orm['cities_light.Country'])),
            ('telefon_fix', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('telefon_mob', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('pais', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pais_set', to=orm['cities_light.Country'])),
            ('ciutat', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['cities_light.City'], null=True, blank=True)),
            ('agencia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Agencia'])),
            ('mitja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Mitja'])),
        ...
        db.send_create_signal(u'premsa', ['Periodista'])

        # Adding M2M table for field idioma on 'Periodista'
        m2m_table_name = db.shorten_name(u'premsa_periodista_idioma')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('periodista', models.ForeignKey(orm[u'premsa.periodista'], null=False)),
            ('idioma', models.ForeignKey(orm[u'reference.idioma'], null=False))
        ))
        db.create_unique(m2m_table_name, ['periodista_id', 'idioma_id'])

        # Adding model 'Periodista_Tipus'
        db.create_table(u'premsa_periodista_tipus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('descripcio', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'premsa', ['Periodista_Tipus'])


        # Changing field 'Agencia.tipus'
        db.alter_column(u'premsa_agencia', 'tipus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Agencia_Tipus']))

        # Changing field 'Mitja.tipus'
        db.alter_column(u'premsa_mitja', 'tipus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Mitja_Tipus']))

    def backwards(self, orm):
        # Deleting model 'Periodista_Carrec'
        db.delete_table(u'premsa_periodista_carrec')

        # Deleting model 'Periodista'
        db.delete_table(u'premsa_periodista')

        # Removing M2M table for field idioma on 'Periodista'
        db.delete_table(db.shorten_name(u'premsa_periodista_idioma'))

        # Deleting model 'Periodista_Tipus'
        db.delete_table(u'premsa_periodista_tipus')
    ...
    models = {
        ...
        u'premsa.periodista': {
            'Meta': {'object_name': 'Periodista'},
            'adreca': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'agencia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['premsa.Agencia']"}),
            'carrec': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['premsa.Periodista_Carrec']"}),
            'ciutat': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['cities_light.City']", 'null': 'True', 'blank': 'True'}),
            'codipostal': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idioma': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['reference.Idioma']", 'symmetrical': 'False'}),
            'mitja': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['premsa.Mitja']"}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pais': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pais_set'", 'to': u"orm['cities_light.Country']"}),
            'pais_origen': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pais_origen_set'", 'to': u"orm['cities_light.Country']"}),
            'skype': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'telefon_fix': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'telefon_mob': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
