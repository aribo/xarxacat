...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Periodista.data_actualitzacio'
        db.delete_column(u'premsa_periodista', 'data_actualitzacio')

        # Deleting field 'Periodista.data_entrada'
        db.delete_column(u'premsa_periodista', 'data_entrada')
        ...
        db.add_column(u'premsa_periodista', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Agencia.data_actualitzacio'
        db.delete_column(u'premsa_agencia', 'data_actualitzacio')

        # Deleting field 'Agencia.data_entrada'
        db.delete_column(u'premsa_agencia', 'data_entrada')
        ...
        # Deleting field 'Mitja.data_actualitzacio'
        db.delete_column(u'premsa_mitja', 'data_actualitzacio')

        # Deleting field 'Mitja.data_entrada'
        db.delete_column(u'premsa_mitja', 'data_entrada')
    ...
    def backwards(self, orm):
        # Adding field 'Periodista.data_actualitzacio'
        db.add_column(u'premsa_periodista', 'data_actualitzacio',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Periodista.data_entrada'
        db.add_column(u'premsa_periodista', 'data_entrada',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Agencia.data_actualitzacio'
        db.add_column(u'premsa_agencia', 'data_actualitzacio',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Agencia.data_entrada'
        db.add_column(u'premsa_agencia', 'data_entrada',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Mitja.data_actualitzacio'
        db.add_column(u'premsa_mitja', 'data_actualitzacio',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Mitja.data_entrada'
        db.add_column(u'premsa_mitja', 'data_entrada',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)
