...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agencia_tipus.nom'
        db.alter_column(u'premsa_agencia_tipus', 'nom', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Mitja_tipus.nom'
        db.alter_column(u'premsa_mitja_tipus', 'nom', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Agencia_tipus.nom'
        db.alter_column(u'premsa_agencia_tipus', 'nom', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Mitja_tipus.nom'
        db.alter_column(u'premsa_mitja_tipus', 'nom', self.gf('django.db.models.fields.CharField')(max_length=255))
