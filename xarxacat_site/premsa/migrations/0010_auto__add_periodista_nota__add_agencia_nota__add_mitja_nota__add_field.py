...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Periodista_Nota'
        db.create_table(u'premsa_periodista_nota', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nota', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('periodista', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Periodista'])),
        ))
        db.send_create_signal(u'premsa', ['Periodista_Nota'])

        # Adding model 'Agencia_Nota'
        db.create_table(u'premsa_agencia_nota', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nota', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('agencia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Agencia'])),
        ))
        db.send_create_signal(u'premsa', ['Agencia_Nota'])

        # Adding model 'Mitja_Nota'
        db.create_table(u'premsa_mitja_nota', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nota', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('mitja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['premsa.Mitja'])),
        ))
        db.send_create_signal(u'premsa', ['Mitja_Nota'])

        # Adding field 'Mitja.url'
        db.add_column(u'premsa_mitja', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Agencia.url'
        db.add_column(u'premsa_agencia', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Periodista_Nota'
        db.delete_table(u'premsa_periodista_nota')

        # Deleting model 'Agencia_Nota'
        db.delete_table(u'premsa_agencia_nota')

        # Deleting model 'Mitja_Nota'
        db.delete_table(u'premsa_mitja_nota')

        # Deleting field 'Mitja.url'
        db.delete_column(u'premsa_mitja', 'url')

        # Deleting field 'Agencia.url'
        db.delete_column(u'premsa_agencia', 'url')
    ...
    models = {
        ...
        u'premsa.agencia_nota': {
            'Meta': {'object_name': 'Agencia_Nota'},
            'agencia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['premsa.Agencia']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nota': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        u'premsa.periodista_nota': {
            'Meta': {'object_name': 'Periodista_Nota'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nota': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'periodista': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['premsa.Periodista']"})
        },
