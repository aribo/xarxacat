...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EmailAe', fields ['email']
        db.create_unique(u'exteriors_emailae', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailAe', fields ['email']
        db.delete_unique(u'exteriors_emailae', ['email'])
