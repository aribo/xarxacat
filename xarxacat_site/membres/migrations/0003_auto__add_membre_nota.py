...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Membre_Nota'
        db.create_table(u'membres_membre_nota', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nota', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('membre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membres.Membre'])),
        ))
        db.send_create_signal(u'membres', ['Membre_Nota'])


    def backwards(self, orm):
        # Deleting model 'Membre_Nota'
        db.delete_table(u'membres_membre_nota')
    ...
    models = {
        ...
        u'membres.membre_nota': {
            'Meta': {'object_name': 'Membre_Nota'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membre': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['membres.Membre']"}),
