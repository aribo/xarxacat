...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membre.carrec_ae'
        db.add_column(u'exteriors_membre', 'carrec_ae',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exteriors.Carrec_Ae'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Membre.carrec_ae'
        db.delete_column(u'exteriors_membre', 'carrec_ae_id')
    ...
    models = {
        ...
        u'exteriors.membre': {
            ...
            'carrec_ae': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exteriors.Carrec_Ae']", 'null': 'True', 'blank': 'True'}),
