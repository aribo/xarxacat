...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exteriors_emailae', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('ae', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exteriors.Ae'])),
            ('tipus', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'exteriors', ['EmailAe'])

        # Adding model 'EmailMembre'
        db.create_table(u'exteriors_emailmembre', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('membre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exteriors.Membre'])),
            ('tipus', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'exteriors', ['EmailMembre'])


    def backwards(self, orm):
        # Deleting model 'EmailAe'
        db.delete_table(u'exteriors_emailae')

        # Deleting model 'EmailMembre'
        db.delete_table(u'exteriors_emailmembre')
    ...
    models = {
        ...
        u'exteriors.emailae': {
            'Meta': {'object_name': 'EmailAe'},
            'ae': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exteriors.Ae']"}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tipus': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        u'exteriors.emailmembre': {
            'Meta': {'object_name': 'EmailMembre'},
            'email': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membre': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exteriors.Membre']"}),
            'tipus': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
