...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membre.pagament'
        db.alter_column(u'exteriors_membre', 'pagament', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Membre.registre_anc'
        db.alter_column(u'exteriors_membre', 'registre_anc', self.gf('django.db.models.fields.BooleanField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Membre.pagament'
        db.alter_column(u'exteriors_membre', 'pagament', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Membre.registre_anc'
        db.alter_column(u'exteriors_membre', 'registre_anc', self.gf('django.db.models.fields.NullBooleanField')(null=True))
