...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Membre', fields ['email']
        db.create_unique(u'exteriors_membre', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Membre', fields ['email']
        db.delete_unique(u'exteriors_membre', ['email'])
