...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exteriors_ae', (
            ...
            ('estat', self.gf('django.db.models.fields.related.ForeignKey')(default=<django.db.models.fields.CharField: nom_en>, to=orm['cities_light.Country'])),
        ...
        db.create_table(u'exteriors_membre', (
            ...
            ('carrec_caec', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exteriors.Carrec_Caec'], null=True, blank=True)),
            ('data_entrada', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('data_actualitzacio', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'exteriors.ae': {
            ...
            'estat': ('django.db.models.fields.related.ForeignKey', [], {'default': '<django.db.models.fields.CharField: nom_en>', 'to': u"orm['cities_light.Country']"}),
        ...
        u'exteriors.membre': {
            ...
            'carrec_caec': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exteriors.Carrec_Caec']", 'null': 'True', 'blank': 'True'}),
