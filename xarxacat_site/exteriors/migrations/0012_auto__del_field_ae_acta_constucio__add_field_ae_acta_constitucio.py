...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ae.acta_constucio'
        db.delete_column(u'exteriors_ae', 'acta_constucio')

        # Adding field 'Ae.acta_constitucio'
        db.add_column(u'exteriors_ae', 'acta_constitucio',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ae.acta_constucio'
        db.add_column(u'exteriors_ae', 'acta_constucio',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ae.acta_constitucio'
        db.delete_column(u'exteriors_ae', 'acta_constitucio')
