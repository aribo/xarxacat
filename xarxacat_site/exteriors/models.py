...
class Membre(models.Model):
    ...
    carrec_ae = models.ManyToManyField(Carrec_Ae, blank=True, null=True, verbose_name="Càrrec a l'AE", help_text="Omplir si membre té càrrec a l'AE.")
    carrec_caec = models.ForeignKey(Carrec_Caec, blank=True, null=True, verbose_name="Càrrec al CAEC",  help_text="Escollir si el membre té un càrrec al Consell.")
